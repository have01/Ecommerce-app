  ...
  return (
    <>
      <div class="container mx-auto mt-1">
        <div class="flex shadow-md my-1 mr-2">
          <div class="w-3/4 bg-white px-10 py-10 mr-2">
            ...
            <span class="text-center w-1/5 font-semibold text-sm hover:text-red-500">
              <DeleteIcon />
            </span>
            <a
              href="#"
          ...
          <div id="summary" class="w-[400px] px-8 py-10 bg-white">
