  ...
  return (
    <>
      <div className="h-[100vh] sm:h-full overflow-y-hidden bg-gradient-to-tl from-green-400 to-indigo-900 w-full py-8 px-4">
        <div className=" container mx-auto flex  items-center  justify-center w-full sm:w-3/5">
          <div className="bg-white shadow rounded lg:w-1/3  md:w-1/2 w-full p-10 mt-10">
            ...
            <div className="mt-6  w-full">
              ...
              <div className="relative flex items-center justify-center">
                <input
                  ...
                  } aria-label="enter Password" role="input" type={isPasswordVisible ? "text" : "password"} className="bg-gray-200 border rounded focus:outline-none text-xs font-medium leading-none text-gray-800 py-3 w-full pl-3 mt-2" />
            ...
            <div className="mt-4">
              <button onClick={handleLogin} role="button" aria-label="create my account" className="focus:ring-2 focus:ring-offset-2 focus:ring-indigo-700 text-sm font-semibold leading-none text-white focus:outline-none bg-indigo-700 border rounded hover:bg-indigo-600 py-4 w-full">
                Login
              </button>
            </div>
