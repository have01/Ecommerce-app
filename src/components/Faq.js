...
const Faq1 = () => {
  ...
  return (
    <div className=" 2xl:container 2xl:mx-auto md:py-3 lg:px-20 md:px-6 py-1 px-4 bg-white mt-3">
      ...
      <div className=" flex md:flex-row flex-col md:space-x-8 md:mt-4 mt-4">
